...
const Header = ({ onClickCart }) => {
    ...
    return (
        <>
            <header>
                <NavLink to="/React-Sneakers" className='headerLeft'>
                    <img src={process.env.PUBLIC_URL + '/img/header-img.svg'} width={40} height={40}/>
                    <div className='headerInfo'>
                        <h3 className='headerInfo-title'>React Sneakers</h3>
                        <p className='headerInfo-comment'>Магазин лучших кросовок</p>
                    </div>
                </NavLink>
                <ul className='headerRight'>
                    <li onClick={onClickCart} className='basket-container'>
                        <svg className='header-stroke-svg' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" alt="Корзина">
                    ...
                    <li>
                        <NavLink to='/React-Sneakers/favorites'>
                            <svg className='header-svg' width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg" alt='Закладки'>
                    ...
                    <li>
                        <NavLink to='/React-Sneakers/orders'>   
                            <svg className='header-svg' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" alt='Профиль'>
